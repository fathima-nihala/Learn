...
export default function Home() {
  ...
  const searchPost = (e) => {
    ...
    //button click cheyyumbo search  nadakaan
    setSearch(true)
    // setTimeout(() => {
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-6">
        <h2 className="text-4xl font-bold mb-4">Welcome to Our LearnCode</h2>
        <p>Build your career by learning your desired courses</p>
      </main>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {!posts.length > 0 && inputRef.current?.value && <p>No post available for this query : <b>{inputRef.current.value}</b></p>}
